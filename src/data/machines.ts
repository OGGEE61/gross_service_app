...
const shredderModules: Module[] = [
  ...
  },
  {
    ...
    position: { x: 20, y: 60 },
    parts: [
      { id: 'mot-belt', partNumber: 'GRS-SHR-MOT-001', name: 'Drive Belt Set', description: 'Set of high-performance V-belts.', price: 140, currency: 'EUR', availability: 'in-stock', category: 'Mechanical' },
      { id: 'mot-pulley', partNumber: 'GRS-SHR-MOT-002', name: 'Motor Pulley', description: 'Cast iron drive pulley.', price: 280, currency: 'EUR', availability: 'low-stock', category: 'Mechanical' },
    ],
  },
  {
    id: 'shr-hydraulics',
    name: 'Hydraulic Pusher',
    description: 'Hydraulically presses material against the rotor.',
    position: { x: 80, y: 40 },
    parts: [
      { id: 'hyd-seal', partNumber: 'GRS-SHR-HYD-001', name: 'Cylinder Seal Kit', description: 'Seal kit for the pusher hydraulic cylinder.', price: 110, currency: 'EUR', availability: 'in-stock', category: 'Seals & Gaskets' },
      { id: 'hyd-filter', partNumber: 'GRS-SHR-HYD-002', name: 'Hydraulic Filter', description: 'Return line oil filter.', price: 45, currency: 'EUR', availability: 'in-stock', category: 'Filters' },
    ],
  },
];
...
export const machines: Machine[] = [
  ...
  // ─── Seria GAZ ────────────────────────────────────────────────────────────
  {
    ...
    description: 'Jednowałowy rozdrabniacz do drewna.',
  ...
  },
  {
    ...
    description: 'Jednowałowy rozdrabniacz do drewna (wersja S).',
  ...
  // ─── Seria GAZK ───────────────────────────────────────────────────────────
  {
    ...
    description: 'Jednowałowy rozdrabniacz do tworzyw sztucznych, papieru i drewna.',
  ...
  // ─── Seria GHZ ────────────────────────────────────────────────────────────
  {
    ...
    description: 'Poziomy jednowałowy rozdrabniacz do długich odpadów drewnianych.',
  ...
  // ─── Seria GZ ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Czterowałowy rozdrabniacz do pracy ciągłej.',
